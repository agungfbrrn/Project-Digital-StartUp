...
case "certificateImages":
  ...
  const handleCertificateChange = (e) => {
    ...
    // Update state dengan file yang diunggah
    setCertificateImages((prevFiles) => {
      const updatedFiles = [...prevFiles, ...files];
      return updatedFiles.slice(0, 3); // Batasi maksimal 3 file
    });
...
>
  ...
  />
          ...
          <h1>Jasaverse<span className="subtext">Penjual.</span></h1>
          {/* Username */}
...
{/* Gambar Sertifikat */}
<label htmlFor="certificateImages">Gambar Sertifikat "max 3"</label>
<input
  type="file"
  ...
  <textarea
    ...
    onChange={(e) => {
      ...
      if (value.trim() === "") {
        setErrors((prev) => ({
          ...prev,
          desc: "Deskripsi tidak boleh kosong",
        }));
      } else {
        setErrors((prev) => ({
          ...prev,
