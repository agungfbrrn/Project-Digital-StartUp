    ...
    <div className="register">
      <form onSubmit={handleSubmit}>
        <div className="left">
          ...
          <h1>Jasaverse<span className="subtext">pembeli.</span></h1>
          {/* Username */}
...
{errors.img && <span className="error">{errors.img}</span>}
        ...
        <div className="right">
          ...
          <button className="register-seller-btn" onClick={() => navigate("/register-seller")}>
  <img src="/img/seller.png" alt="icon" className="icon" />
  Gabung Sebagai Penjual
</button>
