...
function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      localStorage.removeItem("currentUser"); // Hapus currentUser dengan benar
      navigate("/"); // Arahkan ke halaman utama
      window.location.reload(); // Refresh halaman agar perubahan langsung terlihat
    } catch (err) {
      ...
      <div className="container">
        <div className="logo">
          <Link className="link" to="/">
            <span className="text">Jasaverse</span>
          </Link>
        ...
        <div className="links">
          ...
          <Link to="/portofolio">Tim Kami</Link>
